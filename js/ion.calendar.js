        ...
        init: function(options){
            ...
            return this.each(function(){
                ...
                var prepareData = function(){
                    // start date
                    if(settings.startDate && !timeSelected ) {
...
//                    console.log( timeNowLocal.format(), timeNowLocal.format("M"), timeNowLocal.format("m") );
                    ...
                    if(settings.sundayFirst) {
                        ...
                        for(i = 1; i <= monthLastDay; i++) {
                            ...
                            } else if(timeSelected && moment(timeNowLocal).date(i).format("D.M.YYYY") == moment( timeSelected ).format("D.M.YYYY")) {
                ...
                var placeCalendar = function(){
                    ...
                    if(settings.startDate && firstStart) {
                        firstStart = false;
                        timeNowLocal.year(parseInt(moment( timeSelected ).format("YYYY")));
                        timeNowLocal.month(parseInt(moment(timeSelected).format("M") - 1));
                        removeHTML();
                    }
                };
